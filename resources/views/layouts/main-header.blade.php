...
{{--									</a>--}}
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{asset('images/'.auth()->user()->avatar)}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{asset('images/'.auth()->user()->avatar)}}" class=""></div>
											<div class="mr-3 my-auto">
												<h6>{{auth()->user()->name}}</h6><span>{{auth()->user()->email}}</span>
											</div>
										</div>
									</div>
									<a class="dropdown-item" href="{{route('user.profile')}}"><i class="bx bx-user-circle"></i>{{__('messages.Profile')}}</a>
									<a class="dropdown-item" href="{{route('user.profile.edite',auth()->id())}}"><i class="bx bx-cog"></i>{{__('messages.Edit Profile')}} </a>
{{--									<a class="dropdown-item" href=""><i class="bx bxs-inbox"></i>Inbox</a>--}}
{{--									<a class="dropdown-item" href=""><i class="bx bx-envelope"></i>Messages</a>--}}
{{--									<a class="dropdown-item" href=""><i class="bx bx-slider-alt"></i> Account Settings</a>--}}
                                    <hr>
                                    <p class="dropdown-item" href=""><i class="bx bx-slider-alt"></i> {{__('messages.Language')}}</p>
                                    ...
                                    ><i class="bx bx-log-out"></i>{{__('messages.Sign Out')}} </a>
                                    </form>
								</div>
							</div>
