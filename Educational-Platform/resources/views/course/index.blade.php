            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{__('messages.AllCourses')}}</h4>
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap">
                            ...
                            @foreach($courses as $cours)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('courses.edit',$cours)}}" class="btn btn-primary pr-4 pl-4"> {{__('messages.Edit')}}</a>

                                        <form method="post" action="{{route('courses.destroy',$cours)}}" class="d-inline-block p-2 ">
                                            @csrf
                                            @method('DELETE')
