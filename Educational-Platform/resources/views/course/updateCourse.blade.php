            ...
            <div class="row p-2 ">
                <div class="card-body col-lg-9 col-sm-12 col-ms-9">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputE1" name="title" value="{{$course->title}}" >
                        <x-input-error :messages="$errors->get('title')" class="mt-2" />

                    </div>
                    <div class="form-group">
                        <label for="example1">{{__('messages.description')}}</label>
                        <input type="text" class="form-control" id="exampleInput1" name="description" value="{{$course->description}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row row-sm">
                            <div class="input-group col-md-4">
                                ...
                                </div><input class="form-control" id="datetimepicker2" type="text" value="{{$course->start_date}}" name="start_date">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row row-sm">
                            <div class="input-group col-md-4">
                                ...
                                </div><input class="form-control" id="datetimepicker2" type="text" value="{{$course->start_date}}" name="end_date">
