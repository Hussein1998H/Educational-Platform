                ...
                <div class="card-body">
                    ...
                    <div class="tab-content border-left border-bottom border-right border-top-0 p-4">
                        <div class="tab-pane active" id="home">
                            <h4 class="tx-15 text-uppercase mb-3">{{__('messages.aboutme')}}</h4>
                            <p class="m-b-5">{{$user->about}}</p>
                            <hr>
                            <div class="m-t-30">
                                <div class="d-flex justify-content-between border-bottom border-primary py-2 mb-3">
                                <h4 class="tx-15 text-uppercase mt-3">{{__('messages.education')}}</h4>
                                    <div>
                                ...
                                @endforeach
                                <div class="d-flex justify-content-between border-bottom border-primary py-2 mb-3">
                                    <h4 class="tx-15 text-uppercase mt-3">{{__('messages.skills')}}</h4>
